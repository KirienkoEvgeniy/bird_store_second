...
public abstract class AbstractBirdStore {
     ...
     */
    public abstract List<Bird> searchByName(String nameToSearch);
     ...
     */
    public abstract List<Bird> searchByLivingArea(String livingAreaToFind);

    public abstract void deleteBird(Integer id);
}
